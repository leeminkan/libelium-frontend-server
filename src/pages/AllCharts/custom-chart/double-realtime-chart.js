...
class DoubleRealtimeChart extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            options2: {
                chart: {
                    id: `realtime-${props.waspmote_id}-${props.sensor_key}-2`,
                    height: 350,
                    type: 'line',
                    animations: {
                        enabled: true,
    ...
    render() {
        ...
        typeof this.props.data[this.props.waspmote_id][this.props.sensor_key] !== 'undefined') {
            ...
            let newData2 = chartData.map(element => ({
                y: element.time_get_sample,
                x: element.created_at
            }));
            
            if (this.props.reverse) {
                newData = newData.reverse();
                newData2 = newData2.reverse();
            }
            ...
            if (this.state.isMounted) {
                ...
                ApexCharts.exec(`realtime-${this.props.waspmote_id}-${this.props.sensor_key}-2`, 'updateSeries', [{
                    data: newData2
                }]);
            }
        }
...
export default withRouter(connect(mapStatetoProps, { getChartData, updateStateChartData })(DoubleRealtimeChart));